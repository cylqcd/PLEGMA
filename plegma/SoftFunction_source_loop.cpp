...
int main(int argc, char **argv)
{
  ...
  //propUPPp->writeHDF5("propUPPp");
  //propUPp->writeHDF5("propUPp");
      ...
      for(int b = 0; b <= B_max; b++) {//loop over values of B
        ...
        //for(int is = 0; is < numSourcePositions; is++) {//loop over tsource
          ...
          for(int zi = 0; zi < z; zi++) {
            ...
            propUPp->shift(*propIn, WilsDir);
            propExchange = propIn; propIn = propUPPp; propUPPp = propExchange;
            propUPPp->shift(*propIn, 4 + WilsDir);
          }
          for(int bi = 0; bi < b; bi++) {
            propExchange = propIn; propIn = propUPp; propUPp = propExchange;
          ...
          for(int zi = 0; zi < z; zi++) {
            propExchange = propIn; propIn = propUPp; propUPp = propExchange;
            propUPp->shift(*propIn, 4 + WilsDir);
            propExchange = propIn; propIn = propUPPp; propUPPp = propExchange;
            propUPPp->shift(*propIn, WilsDir);
          }
        //}//loop over tsource
