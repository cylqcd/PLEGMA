...
auto packVector = [](plegma::PLEGMA_Vector<double> &out, plegma::PLEGMA_Vector<double> &in, int timeSlice)
{
...
auto packPropogator = [](plegma::PLEGMA_Propagator<double> &out, plegma::PLEGMA_Propagator<double> &in, int timeSlice)
{
    PLEGMA_Vector<double> auxVector;
...
int main(int argc, char **argv)
{
...

    {
	    ...
	    auxVector.writeHDF5("pureinput");
            solver.solve(auxVector, auxVector);
	    auxVector.writeHDF5("pureoutput");
        ...
        auto setupPointPropagator1 = [&](plegma::PLEGMA_Propagator<double> &out, plegma::site &source, FlavorYan f, SmearFlagYan s)
        {
            assert(s < single2double);

            plegma::PLEGMA_Vector<double> auxVector;
            plegma::PLEGMA_Vector<double> auxVectorF;
            plegma::PLEGMA_Vector3D<double> auxVector3D;
            for (int isc = 0; isc < 12; isc++)
            {
        ...
        auto setupPointPropagator2 = [&](plegma::PLEGMA_Propagator<double> &outS, plegma::PLEGMA_Propagator<double> &outL, plegma::site &source, FlavorYan f, SmearFlagYan s)
        {
            assert(single2double < s);
            plegma::PLEGMA_Vector<double> auxVectorS, auxVectorL;
            plegma::PLEGMA_Vector<double> auxVectorSF, auxVectorLF;
            plegma::PLEGMA_Vector3D<double> auxVector3D;
		...
		if (f==u){
			auxVectorS.writeHDF5("propUP_"+std::to_string(isc / 3)+std::to_string( isc % 3));
			}
		else{
			auxVectorS.writeHDF5("propDN_"+std::to_string(isc / 3)+std::to_string( isc % 3));
		}
        ...
        auto setupSequentialPropagator1 = [&](plegma::PLEGMA_Propagator<double> &out, plegma::PLEGMA_Propagator<double> &in, int inTime, plegma::GAMMAS Gamma, std::vector<int> mom, int momSign, FlavorYan f, SmearFlagYan s)
        {
            assert(s < single2double);
            ...
            plegma::PLEGMA_Vector3D<double> auxVector3DF;
        ...
        auto setupSequentialPropagator2 = [&](plegma::PLEGMA_Propagator<double> &outS, plegma::PLEGMA_Propagator<double> &outL, plegma::PLEGMA_Propagator<double> &in, int inTime, plegma::GAMMAS Gamma, std::vector<int> mom, int momSign, FlavorYan f, SmearFlagYan s)
        {
            assert(s > single2double);

            plegma::PLEGMA_Vector<double> auxVectorDS, auxVectorDL;
            plegma::PLEGMA_Vector<double> auxVectorFS, auxVectorFL;
            plegma::PLEGMA_Vector3D<double> auxVector3DD;
            plegma::PLEGMA_Vector3D<double> auxVector3DF;
		...
		if (f==d){
			auxVector3DD.writeHDF5("seq_source_dndn_3d_"+std::to_string(isc / 3)+std::to_string( isc % 3));
		}

                solve2(auxVectorDS, auxVectorDL, auxVector3DD, inTime, f, s);
		                if (f==d){
                        auxVectorDL.writeHDF5("seq_propagator_dndn_3d_"+std::to_string(isc / 3)+std::to_string( isc % 3));
                }
        ...
        plegma::PLEGMA_Propagator<double> propUSS, propUSL;
        plegma::PLEGMA_Propagator<double> propDSS, propDSL;

        setupPointPropagator2(propUSS, propUSL, source, u, SB);
        setupPointPropagator2(propDSS, propDSL, source, d, SB);
	propUSS.writeHDF5(saveDir +"sourceUSS");
	propUSL.writeHDF5(saveDir +"sourceUSL");
	propDSS.writeHDF5(saveDir +"sourceDSS");                                                                     propDSL.writeHDF5(saveDir +"sourceDSL");


        plegma::PLEGMA_Propagator<double> propUSS_pack, propUSL_pack;
        plegma::PLEGMA_Propagator<double> propDSS_pack, propDSL_pack;
        ...
        PLEGMA_Propagator<double> seqUSSDSS, seqUSLDSS, seqUSSUSS, seqUSLUSS, seqDSSDSS, seqDSLDSS;
        PLEGMA_Propagator<double> seqUSSDSS_pack, seqUSLDSS_pack, seqUSSUSS_pack, seqUSLUSS_pack, seqDSSDSS_pack, seqDSLDSS_pack;
        ...
        PLEGMA_Propagator<double> phiV31;
        {
            plegma::PLEGMA_ScattCorrelator<double> auxV3(sourceZero, momList3pt_pc);
            plegma::PLEGMA_Vector<double> auxVector;
            ...
            for (int isc = 0; isc < 12; isc++)
            {
                plegma::PLEGMA_Vector<double> auxVector1;
                ...
                for (int dt = 0; dt < HGC_totalL[3]; dt++)
                {
                    plegma::PLEGMA_Vector3D<double> auxVector3D1;
                    auxVector3D1.copy(auxVector3D);
                    // double *aux = auxV3.Corr((dt+time_i)%HGC_totalL[3], 0, 0);
                    double *aux = auxV3.Corr(dt, 0, 0);
                    std::complex<double> auxC(aux[2 * isc + 0], aux[2 * isc + 1]);
        ...
        PLEGMA_Propagator<double> phiV31UU;
        {
            plegma::PLEGMA_ScattCorrelator<double> auxV3(sourceZero, momList3pt_pc);
            plegma::PLEGMA_Vector<double> auxVector;
            auxVector.copy(stocG5PhiDTfSL);
        ...
        PLEGMA_Propagator<double> phiV31DD;
        {
            plegma::PLEGMA_ScattCorrelator<double> auxV3(sourceZero, momList3pt_pc);
            plegma::PLEGMA_Vector<double> auxVector;
        ...
        PLEGMA_Propagator<double> phiV32;
        {
            plegma::PLEGMA_ScattCorrelator<double> auxV3(sourceZero, momList3pt_pc);
            plegma::PLEGMA_Vector<double> auxVector;
            auxVector.copy(stocG5PhiDTfSL);
        ...
        PLEGMA_Propagator<double> phiV32_DD;
        {
            plegma::PLEGMA_ScattCorrelator<double> auxV3(sourceZero, momList3pt_pc);
            plegma::PLEGMA_Vector<double> auxVector;
            auxVector.copy(stocG5PhiUTfSL);
        ...
        PLEGMA_Propagator<double> phiV33;
        {
            plegma::PLEGMA_ScattCorrelator<double> auxV3(sourceZero, momList3pt_pc);
            plegma::PLEGMA_Vector<double> auxVector;
            auxVector.copy(stocG5PhiUTfSL);
        ...
        PLEGMA_Propagator<double> phiV34;
        {
            plegma::PLEGMA_ScattCorrelator<double> auxV3(sourceZero, momList3pt_pc);
            plegma::PLEGMA_Vector<double> auxVector;
        ...
        PLEGMA_Propagator<double> phiV34_UUU;
        {
            plegma::PLEGMA_ScattCorrelator<double> auxV3(sourceZero, momList3pt_pc);
            plegma::PLEGMA_Vector<double> auxVector;
        ...
        PLEGMA_Propagator<double> phiV34_DDD;
        {
            plegma::PLEGMA_ScattCorrelator<double> auxV3(sourceZero, momList3pt_pc);
            plegma::PLEGMA_Vector<double> auxVector;
            auxVector.copy(stocG5PhiUTiSL);
        ...
        auto outputfile = [&](plegma::PLEGMA_ScattCorrelator<double> sc, std::string filename, bool sgn)
        {
            // momentum phase for pi1
            double phase = 2 * M_PI / (double)HGC_totalL[0] * momVects3pt_pi1[0][0] * source[0] +
                          2 * M_PI / (double)HGC_totalL[1] * momVects3pt_pi1[0][1] * source[1] +
                          2 * M_PI / (double)HGC_totalL[2] * momVects3pt_pi1[0][2] * source[2];
            double expPhase[2] = {cos(phase), sin(phase)};
            x_e_cx<double>(sc.H_elem(), expPhase, sc.getTotalSize());

            // additional sign coming from my Mathematica codes
            double overall_sign[2] = {-1., 0.};
            if (sgn)
                x_e_cx<double>(sc.H_elem(), overall_sign, sc.getTotalSize());
        ...
        // B
        {
            plegma::PLEGMA_ScattCorrelator<double> cont(sourceZero, momVects3pt_pf1);
        ...
        {
            plegma::PLEGMA_Vector<double> auxVector;
            plegma::PLEGMA_ScattCorrelator<double> auxV24(sourceZero, momVects3pt_pf1);
            ...
            seqDSLDSS.writeHDF5(saveDir + "test_V3_2");
            auxV3.writeHDF5(saveDir + "test_V3");

            plegma::PLEGMA_ScattCorrelator<double> cont(sourceZero, momList3pt);
        ...
        // { // B12
        //     plegma::PLEGMA_Vector<double> auxVector;
        //     plegma::PLEGMA_ScattCorrelator<double> auxV4(sourceZero, momVects3pt_pf1);
        //     auxVector.copy(stocG5Xi_pack);
        //     auxVector.writeHDF5(saveDir + "t1");
        //     propUSS_pack.writeHDF5(saveDir + "t2");
        //     propUSS.writeHDF5(saveDir + "t3");
        ...
        //     plegma::PLEGMA_ScattCorrelator<double> cont3V(sourceZero, momList);
        ...
        //     plegma::PLEGMA_ScattCorrelator<double> contZ11(sourceZero, momList);
