  ...
  double start_time, tmp_time;
  {
    ...
    for(int isource = 0 ; isource < numSourcePositions; isource++){
      ...
      for (auto momentum_i2 : sourcemomentumList.uniq_p(0)) {
         ...
         PLEGMA_ScattCorrelator<float> diagramB(MOMENTUM_SPACE, sourcemomentumList.extract(momentum_i2, 0) );

         diagramB.B_diagramms(filtered_sourcemomentumList, reductionsV3, reductionsV2,G4, glist_source_nucleon, "Bdiagramm_Antonino");
