...
int main(int argc, char **argv)
{
  ...
  ft4.writeToFile("/onyx/noether/h/dnole/runs/momTest_field_ft4.dat", ASCII_FORMAT);
  ...
  ft3.writeToFile("/onyx/noether/h/khadjiyiannakou/runs/momTest_prop3D_ft3.dat", ASCII_FORMAT);
