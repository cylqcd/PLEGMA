...
template PLEGMA_FT<float>::PLEGMA_FT<float>( std::vector<std::vector<float>> &,int,bool,int);
template PLEGMA_FT<float>::PLEGMA_FT<double>( std::vector<std::vector<double>> &,int,bool,int);
template PLEGMA_FT<double>::PLEGMA_FT<float>( std::vector<std::vector<float>> &,int,bool,int);
template PLEGMA_FT<double>::PLEGMA_FT<double>( std::vector<std::vector<double>> &,int,bool,int);
