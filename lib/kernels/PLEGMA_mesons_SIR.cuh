...
__global__ void contract_mesons_SIR_device( propTex<FloatA> texProp1,
...
template<typename FloatA, typename FloatB, typename FloatC>
void contract_mesons_SIR_host( ProfileStruct &ps,
  ...
  for(int it=0; it < t_size; it+=time_step) {
	...
	contract_mesons_SIR_device<FloatA, FloatB, FloatC>
...
template<typename FloatA, typename FloatB, typename FloatC>
static void contract_mesons_SIR(PLEGMA_Propagator<FloatA>& prop1, PLEGMA_Propagator<FloatB>& prop2,
				PLEGMA_Correlator<FloatC>& corr){
  bool runFT = (corr.getCorrSpace()==MOMENTUM_SPACE);
  int site_size = 3*N_MESONS;
  ...
  tuneAndRun( ps, "contract_mesons_SIR", contract_mesons_SIR_host<FloatA,FloatB,FloatC>,
