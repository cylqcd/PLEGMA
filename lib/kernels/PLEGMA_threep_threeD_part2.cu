...
__global__ void threep_threeD_part2_device(Float2<FloatC>* block2,
  ...
  if (sid3D < DGC->localVolume3D){
    ...
    // + term x, x-dir1^, x-dir1, x-dir1+dir2-dir3^, x-dir1+dir2-dir3
    /*texture1.get(prop1,vid);*/ /*gaugeTex.get<Minus>(su3_1,dir1,vid,dir1);*/ /*gaugeTex.get<Minus>(su3_2,dir2,vid,dir1);*/ gaugeTex.get<MinusPlusMinus>(su3_3,dir3,vid,dir1,dir2,dir3); texture2.get<MinusPlusMinus>(prop2,vid,dir1,dir2,dir3);
    partial_trace_mul_Prop_G1_G2_G3_Prop<true,ACC_PLUS,true,false,true>(R,prop1,prop2,su3_1,su3_2,su3_3,mu,nu,c1,c2);

    // + term x+dir3, x-dir1+dir3^, x-dir1+dir3, x-dir1+dir2^, x-dir1+dir2
    texture1.get<Plus>(prop1,vid,dir3); gaugeTex.get<MinusPlus>(su3_1,dir1,vid,dir1,dir3); gaugeTex.get<MinusPlus>(su3_2,dir2,vid,dir1,dir3); gaugeTex.get<MinusPlus>(su3_3,dir3,vid,dir1,dir2); texture2.get<MinusPlus>(prop2,vid,dir1,dir2);
    partial_trace_mul_Prop_G1_G2_G3_Prop<true,ACC_PLUS,true,false,true>(R,prop1,prop2,su3_1,su3_2,su3_3,mu,nu,c1,c2);

    // - term x-dir3, x-dir1-dir3^, x-dir1-dir3, x-dir1+dir2-dir3, x-dir1+dir2
    texture1.get<Minus>(prop1,vid,dir3); gaugeTex.get<MinusMinus>(su3_1,dir1,vid,dir1,dir3); gaugeTex.get<MinusMinus>(su3_2,dir2,vid,dir1,dir3); gaugeTex.get<MinusPlusMinus>(su3_3,dir3,vid,dir1,dir2,dir3); /*texture2.get<MinusPlus>(prop2,vid,dir1,dir2);*/
    partial_trace_mul_Prop_G1_G2_G3_Prop<true,ACC_MINUS,true,false,false>(R,prop1,prop2,su3_1,su3_2,su3_3,mu,nu,c1,c2);

    // + term x, x-dir1^, x-dir1-dir2^, x-dir1-dir2, x-dir1-dir2+dir3
    texture1.get(prop1,vid); gaugeTex.get<Minus>(su3_1,dir1,vid,dir1); gaugeTex.get<MinusMinus>(su3_2,dir2,vid,dir1,dir2); gaugeTex.get<MinusMinus>(su3_3,dir3,vid,dir1,dir2); texture2.get<MinusMinusPlus>(prop2,vid,dir1,dir2,dir3);
    partial_trace_mul_Prop_G1_G2_G3_Prop<true,ACC_PLUS,true,true,false>(R,prop1,prop2,su3_1,su3_2,su3_3,mu,nu,c1,c2);

    // - term x, x-dir1^, x-dir1-dir2^, x-dir1-dir2-dir3^, x-dir1-dir2-dir3
    /*texture1.get(prop1,vid);*/ /*gaugeTex.get<Minus>(su3_1,dir1,vid,dir1);*/ /*gaugeTex.get<MinusMinus>(su3_2,dir2,vid,dir1,dir2);*/ gaugeTex.get<MinusMinusMinus>(su3_3,dir3,vid,dir1,dir2,dir3); texture2.get<MinusMinusMinus>(prop2,vid,dir1,dir2,dir3);
    partial_trace_mul_Prop_G1_G2_G3_Prop<true,ACC_MINUS,true,true,true>(R,prop1,prop2,su3_1,su3_2,su3_3,mu,nu,c1,c2);

    // - term x+dir3, x-dir1+dir3^, x-dir1-dir2+dir3^, x-dir1-dir2^, x-dir1-dir2
    texture1.get<Plus>(prop1,vid,dir3); gaugeTex.get<MinusPlus>(su3_1,dir1,vid,dir1,dir3); gaugeTex.get<MinusMinusPlus>(su3_2,dir2,vid,dir1,dir2,dir3); gaugeTex.get<MinusMinus>(su3_3,dir3,vid,dir1,dir2); texture2.get<MinusMinus>(prop2,vid,dir1,dir2);
    partial_trace_mul_Prop_G1_G2_G3_Prop<true,ACC_MINUS,true,true,true>(R,prop1,prop2,su3_1,su3_2,su3_3,mu,nu,c1,c2);

    // + term x-dir3, x-dir1-dir3^, x-dir1-dir2-dir3^, x-dir1-dir2-dir3, x-dir1-dir2
    texture1.get<Minus>(prop1,vid,dir3); gaugeTex.get<MinusMinus>(su3_1,dir1,vid,dir1,dir3); gaugeTex.get<MinusMinusMinus>(su3_2,dir2,vid,dir1,dir2,dir3); gaugeTex.get<MinusMinusMinus>(su3_3,dir3,vid,dir1,dir2,dir3); /*texture2.get<MinusMinus>(prop2,vid,dir1,dir2);*/
    partial_trace_mul_Prop_G1_G2_G3_Prop<true,ACC_PLUS,true,true,false>(R,prop1,prop2,su3_1,su3_2,su3_3,mu,nu,c1,c2);

    // + term x+dir2, x-dir1+dir2^, x-dir1^, x-dir1, x-dir1+dir3
    texture1.get<Plus>(prop1,vid,dir2); gaugeTex.get<MinusPlus>(su3_1,dir1,vid,dir1,dir2); gaugeTex.get<Minus>(su3_2,dir2,vid,dir1); gaugeTex.get<Minus>(su3_3,dir3,vid,dir1); texture2.get<MinusPlus>(prop2,vid,dir1,dir3);
    partial_trace_mul_Prop_G1_G2_G3_Prop<true,ACC_PLUS,true,true,false>(R,prop1,prop2,su3_1,su3_2,su3_3,mu,nu,c1,c2);

    // - term x+dir2, x-dir1+dir2^, x-dir1^, x-dir1-dir3^, x-dir1-dir3
    /*texture1.get<Plus>(prop1,vid,dir2);*/ /*gaugeTex.get<MinusPlus>(su3_1,dir1,vid,dir1,dir2);*/ /*gaugeTex.get<Minus>(su3_2,dir2,vid,dir1);*/ gaugeTex.get<MinusMinus>(su3_3,dir3,vid,dir1,dir3); texture2.get<MinusMinus>(prop2,vid,dir1,dir3);
    partial_trace_mul_Prop_G1_G2_G3_Prop<true,ACC_MINUS,true,true,true>(R,prop1,prop2,su3_1,su3_2,su3_3,mu,nu,c1,c2);

    // - term x+dir2+dir3, x-dir1+dir2+dir3^, x-dir1+dir3^, x-dir1^, x-dir1
    texture1.get<PlusPlus>(prop1,vid,dir2,dir3); gaugeTex.get<MinusPlusPlus>(su3_1,dir1,vid,dir1,dir2,dir3); gaugeTex.get<MinusPlus>(su3_2,dir2,vid,dir1,dir3); gaugeTex.get<Minus>(su3_3,dir3,vid,dir1); texture2.get<Minus>(prop2,vid,dir1);
    partial_trace_mul_Prop_G1_G2_G3_Prop<true,ACC_MINUS,true,true,true>(R,prop1,prop2,su3_1,su3_2,su3_3,mu,nu,c1,c2);

    // + term x+dir2-dir3, x-dir1+dir2-dir3^, x-dir1-dir3^, x-dir1-dir3, x-dir1
    texture1.get<PlusMinus>(prop1,vid,dir2,dir3); gaugeTex.get<MinusPlusMinus>(su3_1,dir1,vid,dir1,dir2,dir3); gaugeTex.get<MinusMinus>(su3_2,dir2,vid,dir1,dir3); gaugeTex.get<MinusMinus>(su3_3,dir3,vid,dir1,dir3); /*texture2.get<Minus>(prop2,vid,dir1);*/
    partial_trace_mul_Prop_G1_G2_G3_Prop<true,ACC_PLUS,true,true,false>(R,prop1,prop2,su3_1,su3_2,su3_3,mu,nu,c1,c2);

    // - term x-dir2, x-dir1-dir2^, x-dir1-dir2, x-dir1, x-dir1+dir3
    texture1.get<Minus>(prop1,vid,dir2); gaugeTex.get<MinusMinus>(su3_1,dir1,vid,dir1,dir2); gaugeTex.get<MinusMinus>(su3_2,dir2,vid,dir1,dir2); gaugeTex.get<Minus>(su3_3,dir3,vid,dir1); texture2.get<MinusPlus>(prop2,vid,dir1,dir3);
    partial_trace_mul_Prop_G1_G2_G3_Prop<true,ACC_MINUS,true,false,false>(R,prop1,prop2,su3_1,su3_2,su3_3,mu,nu,c1,c2);

    // + term x-dir2, x-dir1-dir2^, x-dir1-dir2, x-dir1-dir3^, x-dir1-dir3
    /*texture1.get<Minus>(prop1,vid,dir2);*/ /*gaugeTex.get<MinusMinus>(su3_1,dir1,vid,dir1,dir2);*/ /*gaugeTex.get<MinusMinus>(su3_2,dir2,vid,dir1,dir2);*/ gaugeTex.get<MinusMinus>(su3_3,dir3,vid,dir1,dir3); texture2.get<MinusMinus>(prop2,vid,dir1,dir3);
    partial_trace_mul_Prop_G1_G2_G3_Prop<true,ACC_PLUS,true,false,true>(R,prop1,prop2,su3_1,su3_2,su3_3,mu,nu,c1,c2);

    // + term x-dir2+dir3, x-dir1-dir2+dir3^, x-dir1-dir2+dir3, x-dir1^, x-dir1
    texture1.get<MinusPlus>(prop1,vid,dir2,dir3); gaugeTex.get<MinusMinusPlus>(su3_1,dir1,vid,dir1,dir2,dir3); gaugeTex.get<MinusMinusPlus>(su3_2,dir2,vid,dir1,dir2,dir3); gaugeTex.get<Minus>(su3_3,dir3,vid,dir1); texture2.get<Minus>(prop2,vid,dir1);
    partial_trace_mul_Prop_G1_G2_G3_Prop<true,ACC_PLUS,true,false,true>(R,prop1,prop2,su3_1,su3_2,su3_3,mu,nu,c1,c2);
  ...
  if(runFT){
	...
	block2[(tid*DGC->localVolume3D + sid3D)*site_size+iop] = accum[iop];
  }
}

template<bool b,typename FloatC,typename FloatA, typename FloatB, typename FloatG>
static void threep_threeD_part2_host(ProfileStruct &ps, Float2<FloatC> *result, PLEGMA_Correlator<FloatC> &corr,
                              PorV<b, FloatA> &prop1,
                              PorV<b, FloatB> &prop2,
...
//  cudaMalloc((void**)&d_partial_block, alloc_size * sizeof(Float2<FloatC>) );
  ...
  auto propTex2 = toTexture<PorVtex<b,FloatA>>(prop2);
...
//  if(error != cudaSuccess || h_partial_block==NULL) goto exit;
  for(int it=0; it < t_size; it+=time_step) {
	...
	c2=tt%N_COLS;
      ...
      threep_threeD_part2_device<b,FloatC,FloatA, FloatB, FloatG>
...
template<bool b,typename FloatC,typename FloatA,typename FloatB,typename FloatG>
void threep_threeD_part2(PLEGMA_Correlator<FloatC> &corr, 
  ...
  run( ps, "threep_threeD", threep_threeD_part2_host<b, FloatC,FloatA,FloatB,FloatG>,
...
template void threep_threeD_part2<true,float,float,float,float>(PLEGMA_Correlator<float> &corr, PLEGMA_Propagator<float>& prop1, PLEGMA_Propagator<float>& prop2, int signProps, PLEGMA_Gauge<float>& gauge, std::vector<GAMMAS>& gammas, bool isZfac);
template void threep_threeD_part2<true,double,double,double,double>(PLEGMA_Correlator<double> &corr, PLEGMA_Propagator<double>& prop1, PLEGMA_Propagator<double>& prop2, int signProps, PLEGMA_Gauge<double>& gauge, std::vector<GAMMAS>& gammas, bool isZfac);

template void threep_threeD_part2<false,float,float,float,float>(PLEGMA_Correlator<float> &corr, PLEGMA_Vector<float>& prop1, PLEGMA_Vector<float>& prop2, int signProps, PLEGMA_Gauge<float>& gauge, std::vector<GAMMAS>& gammas, bool isZfac);
template void threep_threeD_part2<false,double,double,double,double>(PLEGMA_Correlator<double> &corr, PLEGMA_Vector<double>& prop1, PLEGMA_Vector<double>& prop2, int signProps, PLEGMA_Gauge<double>& gauge, std::vector<GAMMAS>& gammas, bool isZfac);
