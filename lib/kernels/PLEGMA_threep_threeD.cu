...
__global__ void threep_threeD_device(Float2<FloatC>* block2,
  ...
  Float2<FloatC> accum[N_DIMS*(N_DIMS-1)*(N_DIMS-2)*N_SPINS*N_SPINS];
  #pragma unroll
  for(int i = 0; i < N_DIMS*(N_DIMS-1)*(N_DIMS-2)*N_SPINS*N_SPINS; i++)
    accum[i]=0;
  ...
  if (sid3D < DGC_localVolume3D){
	...
	if(dir1 == dir2) continue;
        #pragma unroll
	for(int dir3 = 0; dir3 < N_DIMS; dir3++) {
	  if(dir1 == dir3 || dir2 == dir3) continue;
          ...
          prop1Tex.get(prop1,vid); gaugeTex.get(su3_1,dir1,vid); gaugeTex.get<Plus>(su3_2,dir2,vid,dir1); gaugeTex.get<PlusPlus>(su3_3,dir3,vid,dir1,dir2); prop2Tex.get<PlusPlusPlus>(prop2,vid,dir1,dir2,dir3);
          partial_trace_mul_Prop_G1_G2_G3_Prop<true,ACC_PLUS,false,false,false>(R,prop1,prop2,su3_1,su3_2,su3_3);

          // - term x, x, x+dir1, x+dir1+dir2-dir3^, x+dir1+dir2-dir3
          /*prop1Tex.get(prop1,vid);*/ /*gaugeTex.get(su3_1,dir1,vid);*/ /*gaugeTex.get<Plus>(su3_2,dir2,vid,dir1);*/ gaugeTex.get<PlusPlusMinus>(su3_3,dir3,vid,dir1,dir2,dir3); prop2Tex.get<PlusPlusMinus>(prop2,vid,dir1,dir2,dir3);
          partial_trace_mul_Prop_G1_G2_G3_Prop<true,ACC_MINUS,false,false,true>(R,prop1,prop2,su3_1,su3_2,su3_3);

          // - term x+dir3, x+dir3, x+dir1+dir3, x+dir1+dir2^, x+dir1+dir2
          prop1Tex.get<Plus>(prop1,vid,dir3); gaugeTex.get<Plus>(su3_1,dir1,vid,dir3); gaugeTex.get<PlusPlus>(su3_2,dir2,vid,dir1,dir3); gaugeTex.get<PlusPlus>(su3_3,dir3,vid,dir1,dir2); prop2Tex.get<PlusPlus>(prop2,vid,dir1,dir2);
          partial_trace_mul_Prop_G1_G2_G3_Prop<true,ACC_MINUS,false,false,true>(R,prop1,prop2,su3_1,su3_2,su3_3);

          // + term x-dir3, x-dir3, x+dir1-dir3, x+dir1+dir2-dir3, x+dir1+dir2
          prop1Tex.get<Minus>(prop1,vid,dir3); gaugeTex.get<Minus>(su3_1,dir1,vid,dir3); gaugeTex.get<PlusMinus>(su3_2,dir2,vid,dir1,dir3); gaugeTex.get<PlusPlusMinus>(su3_3,dir3,vid,dir1,dir2,dir3); /*prop2Tex.get<PlusPlus>(prop2,vid,dir1,dir2);*/
          partial_trace_mul_Prop_G1_G2_G3_Prop<true,ACC_PLUS,false,false,false>(R,prop1,prop2,su3_1,su3_2,su3_3);

          // - term x, x, x+dir1-dir2^, x+dir1-dir2, x+dir1-dir2+dir3
          prop1Tex.get(prop1,vid); gaugeTex.get(su3_1,dir1,vid); gaugeTex.get<PlusMinus>(su3_2,dir2,vid,dir1,dir2); gaugeTex.get<PlusMinus>(su3_3,dir3,vid,dir1,dir2); prop2Tex.get<PlusMinusPlus>(prop2,vid,dir1,dir2,dir3);
          partial_trace_mul_Prop_G1_G2_G3_Prop<true,ACC_MINUS,false,true,false>(R,prop1,prop2,su3_1,su3_2,su3_3);

          // + term x, x, x+dir1-dir2^, x+dir1-dir2-dir3^, x+dir1-dir2-dir3
          /*prop1Tex.get(prop1,vid);*/ /*gaugeTex.get(su3_1,dir1,vid);*/ /*gaugeTex.get<PlusMinus>(su3_2,dir2,vid,dir1,dir2);*/ gaugeTex.get<PlusMinusMinus>(su3_3,dir3,vid,dir1,dir2,dir3); prop2Tex.get<PlusMinusMinus>(prop2,vid,dir1,dir2,dir3);
          partial_trace_mul_Prop_G1_G2_G3_Prop<true,ACC_PLUS,false,true,true>(R,prop1,prop2,su3_1,su3_2,su3_3);

          // + term x+dir3, x+dir3, x+dir1-dir2+dir3^, x+dir1-dir2^, x+dir1-dir2
          prop1Tex.get<Plus>(prop1,vid,dir3); gaugeTex.get<Plus>(su3_1,dir1,vid,dir3); gaugeTex.get<PlusMinusPlus>(su3_2,dir2,vid,dir1,dir2,dir3); gaugeTex.get<PlusMinus>(su3_3,dir3,vid,dir1,dir2); prop2Tex.get<PlusMinus>(prop2,vid,dir1,dir2);
          partial_trace_mul_Prop_G1_G2_G3_Prop<true,ACC_PLUS,false,true,true>(R,prop1,prop2,su3_1,su3_2,su3_3);

          // - term x-dir3, x-dir3, x+dir1-dir2-dir3^, x+dir1-dir2-dir3, x+dir1-dir2
          prop1Tex.get<Minus>(prop1,vid,dir3); gaugeTex.get<Minus>(su3_1,dir1,vid,dir3); gaugeTex.get<PlusMinusMinus>(su3_2,dir2,vid,dir1,dir2,dir3); gaugeTex.get<PlusMinusMinus>(su3_3,dir3,vid,dir1,dir2,dir3); /*prop2Tex.get<PlusMinus>(prop2,vid,dir1,dir2);*/
          partial_trace_mul_Prop_G1_G2_G3_Prop<true,ACC_MINUS,false,true,false>(R,prop1,prop2,su3_1,su3_2,su3_3);

          // - term x+dir2, x+dir2, x+dir1^, x+dir1, x+dir1+dir3
          prop1Tex.get<Plus>(prop1,vid,dir2); gaugeTex.get<Plus>(su3_1,dir1,vid,dir2); gaugeTex.get<Plus>(su3_2,dir2,vid,dir1); gaugeTex.get<Plus>(su3_3,dir3,vid,dir1); prop2Tex.get<PlusPlus>(prop2,vid,dir1,dir3);
          partial_trace_mul_Prop_G1_G2_G3_Prop<true,ACC_MINUS,false,true,false>(R,prop1,prop2,su3_1,su3_2,su3_3);

          // + term x+dir2, x+dir2, x+dir1^, x+dir1-dir3^, x+dir1-dir3
          /*prop1Tex.get<Plus>(prop1,vid,dir2);*/ /*gaugeTex.get<Plus>(su3_1,dir1,vid,dir2);*/ /*gaugeTex.get<Plus>(su3_2,dir2,vid,dir1);*/ gaugeTex.get<PlusMinus>(su3_3,dir3,vid,dir1,dir3); prop2Tex.get<PlusMinus>(prop2,vid,dir1,dir3);
          partial_trace_mul_Prop_G1_G2_G3_Prop<true,ACC_PLUS,false,true,true>(R,prop1,prop2,su3_1,su3_2,su3_3);

          // + term x+dir2+dir3, x+dir2+dir3, x+dir1+dir3^, x+dir1^, x+dir1
          prop1Tex.get<PlusPlus>(prop1,vid,dir2,dir3); gaugeTex.get<PlusPlus>(su3_1,dir1,vid,dir2,dir3); gaugeTex.get<PlusPlus>(su3_2,dir2,vid,dir1,dir3); gaugeTex.get<Plus>(su3_3,dir3,vid,dir1); prop2Tex.get<Plus>(prop2,vid,dir1);
          partial_trace_mul_Prop_G1_G2_G3_Prop<true,ACC_PLUS,false,true,true>(R,prop1,prop2,su3_1,su3_2,su3_3);

          // - term x+dir2-dir3, x+dir2-dir3, x+dir1-dir3^, x+dir1-dir3, x+dir1
          prop1Tex.get<PlusMinus>(prop1,vid,dir2,dir3); gaugeTex.get<PlusMinus>(su3_1,dir1,vid,dir2,dir3); gaugeTex.get<PlusMinus>(su3_2,dir2,vid,dir1,dir3); gaugeTex.get<PlusMinus>(su3_3,dir3,vid,dir1,dir3); /*prop2Tex.get<Plus>(prop2,vid,dir1);*/
          partial_trace_mul_Prop_G1_G2_G3_Prop<true,ACC_MINUS,false,true,false>(R,prop1,prop2,su3_1,su3_2,su3_3);

          // + term x-dir2, x-dir2, x+dir1-dir2, x+dir1, x+dir1+dir3
          prop1Tex.get<Minus>(prop1,vid,dir2); gaugeTex.get<Minus>(su3_1,dir1,vid,dir2); gaugeTex.get<PlusMinus>(su3_2,dir2,vid,dir1,dir2); gaugeTex.get<Plus>(su3_3,dir3,vid,dir1); prop2Tex.get<PlusPlus>(prop2,vid,dir1,dir3);
          partial_trace_mul_Prop_G1_G2_G3_Prop<true,ACC_PLUS,false,false,false>(R,prop1,prop2,su3_1,su3_2,su3_3);

          // - term x-dir2, x-dir2, x+dir1-dir2, x+dir1-dir3^, x+dir1-dir3
          /*prop1Tex.get<Minus>(prop1,vid,dir2);*/ /*gaugeTex.get<Minus>(su3_1,dir1,vid,dir2);*/ /*gaugeTex.get<PlusMinus>(su3_2,dir2,vid,dir1,dir2);*/ gaugeTex.get<PlusMinus>(su3_3,dir3,vid,dir1,dir3); prop2Tex.get<PlusMinus>(prop2,vid,dir1,dir3);
          partial_trace_mul_Prop_G1_G2_G3_Prop<true,ACC_MINUS,false,false,true>(R,prop1,prop2,su3_1,su3_2,su3_3);

          // - term x-dir2+dir3, x-dir2+dir3, x+dir1-dir2+dir3, x+dir1^, x+dir1
          prop1Tex.get<MinusPlus>(prop1,vid,dir2,dir3); gaugeTex.get<MinusPlus>(su3_1,dir1,vid,dir2,dir3); gaugeTex.get<PlusMinusPlus>(su3_2,dir2,vid,dir1,dir2,dir3); gaugeTex.get<Plus>(su3_3,dir3,vid,dir1); prop2Tex.get<Plus>(prop2,vid,dir1);
          partial_trace_mul_Prop_G1_G2_G3_Prop<true,ACC_MINUS,false,false,true>(R,prop1,prop2,su3_1,su3_2,su3_3);

          // + term x-dir2-dir3, x-dir2-dir3, x+dir1-dir2-dir3, x+dir1-dir3, x+dir1
          prop1Tex.get<MinusMinus>(prop1,vid,dir2,dir3); gaugeTex.get<MinusMinus>(su3_1,dir1,vid,dir2,dir3); gaugeTex.get<PlusMinusMinus>(su3_2,dir2,vid,dir1,dir2,dir3); gaugeTex.get<PlusMinus>(su3_3,dir3,vid,dir1,dir3); /*prop2Tex.get<Plus>(prop2,vid,dir1);*/
          partial_trace_mul_Prop_G1_G2_G3_Prop<true,ACC_PLUS,false,false,false>(R,prop1,prop2,su3_1,su3_2,su3_3);
          ...
          partial_trace_mul_Prop_G1_G2_G3_Prop<true,ACC_MINUS,true,false,false>(R,prop1,prop2,su3_1,su3_2,su3_3);
          ...
          partial_trace_mul_Prop_G1_G2_G3_Prop<true,ACC_PLUS,true,false,true>(R,prop1,prop2,su3_1,su3_2,su3_3);
          ...
          partial_trace_mul_Prop_G1_G2_G3_Prop<true,ACC_PLUS,true,true,false>(R,prop1,prop2,su3_1,su3_2,su3_3);
          ...
          partial_trace_mul_Prop_G1_G2_G3_Prop<true,ACC_MINUS,true,true,true>(R,prop1,prop2,su3_1,su3_2,su3_3);
	  ...
	  for(int iop = 0; iop < listGammas.size; iop++){
	    ...
	    accum[dir_index*listGammas.size + iop] = 0.015625*((signProps > 0) ? trace_gamma_S<true>(opId,TMP,R) : trace_gamma_S<true>(opId,TMM,R));
	  }
	  dir_index++;
	}
      }
  ...
  int site_size = N_DIMS*(N_DIMS-1)*(N_DIMS-2)*listGammas.size;
...
template<typename FloatC,typename FloatA, typename FloatB, typename FloatG>
static void threep_threeD_host(ProfileStruct &ps, Float2<FloatC> *result, PLEGMA_Correlator<FloatC> &corr,
...
template<typename FloatC,typename FloatA,typename FloatB,typename FloatG>
void threep_threeD(PLEGMA_Correlator<FloatC> &corr, PLEGMA_Propagator<FloatA>& prop1, PLEGMA_Propagator<FloatB>& prop2,
		 int signProps, PLEGMA_Gauge<FloatG>& gauge, std::vector<GAMMAS>& gammas){
...
template void threep_threeD<float,float,float,float>(PLEGMA_Correlator<float> &corr, PLEGMA_Propagator<float>& prop1, PLEGMA_Propagator<float>& prop2, int signProps, PLEGMA_Gauge<float>& gauge, std::vector<GAMMAS>& gammas);
template void threep_threeD<double,double,double,double>(PLEGMA_Correlator<double> &corr, PLEGMA_Propagator<double>& prop1, PLEGMA_Propagator<double>& prop2, int signProps, PLEGMA_Gauge<double>& gauge, std::vector<GAMMAS>& gammas);
