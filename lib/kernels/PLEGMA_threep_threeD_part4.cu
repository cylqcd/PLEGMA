...
__global__ void threep_threeD_part4_device(Float2<FloatC>* block2,
  ...
  if (sid3D < DGC_localVolume3D){
    ...
    /*texture1.get<Minus>(prop1,vid,dir1);*/ /*gaugeTex.get<Minus>(su3_1,dir1,vid,dir1);*/ /*gaugeTex.get(su3_2,dir2,vid);*/ gaugeTex.get<PlusMinus>(su3_3,dir3,vid,dir2,dir3); texture2.get<PlusMinus>(prop2,vid,dir2,dir3);
    ...
    texture1.get<MinusPlus>(prop1,vid,dir1,dir3); gaugeTex.get<MinusPlus>(su3_1,dir1,vid,dir1,dir3); gaugeTex.get<Plus>(su3_2,dir2,vid,dir3); gaugeTex.get<Plus>(su3_3,dir3,vid,dir2); texture2.get<Plus>(prop2,vid,dir2);
    partial_trace_mul_Prop_G1_G2_G3_Prop<true,ACC_MINUS,false,false,true>(R,prop1,prop2,su3_1,su3_2,su3_3,mu,nu,c1,c2);

    // + term x-dir1-dir3, x-dir1-dir3, x-dir3, x+dir2-dir3, x+dir2
    texture1.get<MinusMinus>(prop1,vid,dir1,dir3); gaugeTex.get<MinusMinus>(su3_1,dir1,vid,dir1,dir3); gaugeTex.get<Minus>(su3_2,dir2,vid,dir3); gaugeTex.get<PlusMinus>(su3_3,dir3,vid,dir2,dir3); /*texture2.get<Plus>(prop2,vid,dir2);*/
    ...
    texture1.get<Minus>(prop1,vid,dir1); gaugeTex.get<Minus>(su3_1,dir1,vid,dir1); gaugeTex.get<Minus>(su3_2,dir2,vid,dir2); gaugeTex.get<Minus>(su3_3,dir3,vid,dir2); texture2.get<MinusPlus>(prop2,vid,dir2,dir3);
    ...
    /*texture1.get<Minus>(prop1,vid,dir1);*/ /*gaugeTex.get<Minus>(su3_1,dir1,vid,dir1);*/ /*gaugeTex.get<Minus>(su3_2,dir2,vid,dir2);*/ gaugeTex.get<MinusMinus>(su3_3,dir3,vid,dir2,dir3); texture2.get<MinusMinus>(prop2,vid,dir2,dir3);
    ...
    texture1.get<MinusPlus>(prop1,vid,dir1,dir3); gaugeTex.get<MinusPlus>(su3_1,dir1,vid,dir1,dir3); gaugeTex.get<MinusPlus>(su3_2,dir2,vid,dir2,dir3); gaugeTex.get<Minus>(su3_3,dir3,vid,dir2); texture2.get<Minus>(prop2,vid,dir2);
    partial_trace_mul_Prop_G1_G2_G3_Prop<true,ACC_PLUS,false,true,true>(R,prop1,prop2,su3_1,su3_2,su3_3,mu,nu,c1,c2);

    // - term x-dir1-dir3, x-dir1-dir3, x-dir2-dir3^, x-dir2-dir3, x-dir2
    texture1.get<MinusMinus>(prop1,vid,dir1,dir3); gaugeTex.get<MinusMinus>(su3_1,dir1,vid,dir1,dir3); gaugeTex.get<MinusMinus>(su3_2,dir2,vid,dir2,dir3); gaugeTex.get<MinusMinus>(su3_3,dir3,vid,dir2,dir3); /*texture2.get<Minus>(prop2,vid,dir2);*/
    partial_trace_mul_Prop_G1_G2_G3_Prop<true,ACC_MINUS,false,true,false>(R,prop1,prop2,su3_1,su3_2,su3_3,mu,nu,c1,c2);

    // - term x-dir1+dir2, x-dir1+dir2, x^, x, x+dir3
    texture1.get<MinusPlus>(prop1,vid,dir1,dir2); gaugeTex.get<MinusPlus>(su3_1,dir1,vid,dir1,dir2); gaugeTex.get(su3_2,dir2,vid); gaugeTex.get(su3_3,dir3,vid); texture2.get<Plus>(prop2,vid,dir3);
    partial_trace_mul_Prop_G1_G2_G3_Prop<true,ACC_MINUS,false,true,false>(R,prop1,prop2,su3_1,su3_2,su3_3,mu,nu,c1,c2);

    // + term x-dir1+dir2, x-dir1+dir2, x^, x-dir3^, x-dir3
    /*texture1.get<MinusPlus>(prop1,vid,dir1,dir2);*/ /*gaugeTex.get<MinusPlus>(su3_1,dir1,vid,dir1,dir2);*/ /*gaugeTex.get(su3_2,dir2,vid);*/ gaugeTex.get<Minus>(su3_3,dir3,vid,dir3); texture2.get<Minus>(prop2,vid,dir3);
    partial_trace_mul_Prop_G1_G2_G3_Prop<true,ACC_PLUS,false,true,true>(R,prop1,prop2,su3_1,su3_2,su3_3,mu,nu,c1,c2);

    // - term x-dir1-dir2, x-dir1-dir2, x-dir2, x-dir3^, x-dir3
    texture1.get<MinusMinus>(prop1,vid,dir1,dir2); gaugeTex.get<MinusMinus>(su3_1,dir1,vid,dir1,dir2); gaugeTex.get<Minus>(su3_2,dir2,vid,dir2); /*gaugeTex.get<Minus>(su3_3,dir3,vid,dir3);*/ /*texture2.get<Minus>(prop2,vid,dir3);*/
    partial_trace_mul_Prop_G1_G2_G3_Prop<true,ACC_MINUS,false,false,true>(R,prop1,prop2,su3_1,su3_2,su3_3,mu,nu,c1,c2);

    // + term x-dir1-dir2, x-dir1-dir2, x-dir2, x, x+dir3
    /*texture1.get<MinusMinus>(prop1,vid,dir1,dir2);*/ /*gaugeTex.get<MinusMinus>(su3_1,dir1,vid,dir1,dir2);*/ /*gaugeTex.get<Minus>(su3_2,dir2,vid,dir2);*/ gaugeTex.get(su3_3,dir3,vid); texture2.get<Plus>(prop2,vid,dir3);
    partial_trace_mul_Prop_G1_G2_G3_Prop<true,ACC_PLUS,false,false,false>(R,prop1,prop2,su3_1,su3_2,su3_3,mu,nu,c1,c2);

    // + term x-dir1+dir2+dir3, x-dir1+dir2+dir3, x+dir3^, x^, x
    texture1.get<MinusPlusPlus>(prop1,vid,dir1,dir2,dir3); gaugeTex.get<MinusPlusPlus>(su3_1,dir1,vid,dir1,dir2,dir3); gaugeTex.get<Plus>(su3_2,dir2,vid,dir3); /*gaugeTex.get(su3_3,dir3,vid);*/ texture2.get(prop2,vid);
    partial_trace_mul_Prop_G1_G2_G3_Prop<true,ACC_PLUS,false,true,true>(R,prop1,prop2,su3_1,su3_2,su3_3,mu,nu,c1,c2);

    // - term x-dir1-dir2+dir3, x-dir1-dir2+dir3, x-dir2+dir3, x^, x
    texture1.get<MinusMinusPlus>(prop1,vid,dir1,dir2,dir3); gaugeTex.get<MinusMinusPlus>(su3_1,dir1,vid,dir1,dir2,dir3); gaugeTex.get<MinusPlus>(su3_2,dir2,vid,dir2,dir3); /*gaugeTex.get(su3_3,dir3,vid);*/ /*texture2.get(prop2,vid);*/
    partial_trace_mul_Prop_G1_G2_G3_Prop<true,ACC_MINUS,false,false,true>(R,prop1,prop2,su3_1,su3_2,su3_3,mu,nu,c1,c2);

    // - term x-dir1+dir2-dir3, x-dir1+dir2-dir3, x-dir3^, x-dir3, x
    texture1.get<MinusPlusMinus>(prop1,vid,dir1,dir2,dir3); gaugeTex.get<MinusPlusMinus>(su3_1,dir1,vid,dir1,dir2,dir3); gaugeTex.get<Minus>(su3_2,dir2,vid,dir3); gaugeTex.get<Minus>(su3_3,dir3,vid,dir3); /*texture2.get(prop2,vid);*/
    partial_trace_mul_Prop_G1_G2_G3_Prop<true,ACC_MINUS,false,true,false>(R,prop1,prop2,su3_1,su3_2,su3_3,mu,nu,c1,c2);

    // + term x-dir1-dir2-dir3, x-dir1-dir2-dir3, x-dir2-dir3, x-dir3, x
    texture1.get<MinusMinusMinus>(prop1,vid,dir1,dir2,dir3); gaugeTex.get<MinusMinusMinus>(su3_1,dir1,vid,dir1,dir2,dir3); gaugeTex.get<MinusMinus>(su3_2,dir2,vid,dir2,dir3); /*gaugeTex.get<Minus>(su3_3,dir3,vid,dir3);*/ /*texture2.get(prop2,vid);*/
    partial_trace_mul_Prop_G1_G2_G3_Prop<true,ACC_PLUS,false,false,false>(R,prop1,prop2,su3_1,su3_2,su3_3,mu,nu,c1,c2);
#endif	
...
//  cudaMalloc((void**)&d_partial_block, alloc_size * sizeof(Float2<FloatC>) );
  ...
  for(int it=0; it < t_size; it+=time_step) {
	...
	c2=tt%N_COLS;
      ...
      threep_threeD_part4_device<b,FloatC,FloatA, FloatB, FloatG>
...
template<bool b, typename FloatC,typename FloatA,typename FloatB,typename FloatG>
void threep_threeD_part4(PLEGMA_Correlator<FloatC> &corr, 
  ...
  tune( ps, "threep_threeD", threep_threeD_part4_host<b,FloatC,FloatA,FloatB,FloatG>,
	ps, result, corr, prop1, prop2, signProps, gauge, gammas,false);
  run( ps, "threep_threeD", threep_threeD_part4_host<b,FloatC,FloatA,FloatB,FloatG>,
...
template void threep_threeD_part4<true,float,float,float,float>(PLEGMA_Correlator<float> &corr, PLEGMA_Propagator<float>& prop1, PLEGMA_Propagator<float>& prop2, int signProps, PLEGMA_Gauge<float>& gauge, std::vector<GAMMAS>& gammas, bool isZfac);
template void threep_threeD_part4<true,double,double,double,double>(PLEGMA_Correlator<double> &corr, PLEGMA_Propagator<double>& prop1, PLEGMA_Propagator<double>& prop2, int signProps, PLEGMA_Gauge<double>& gauge, std::vector<GAMMAS>& gammas, bool isZfac);

template void threep_threeD_part4<false,float,float,float,float>(PLEGMA_Correlator<float> &corr, PLEGMA_Vector<float>& prop1, PLEGMA_Vector<float>& prop2, int signProps, PLEGMA_Gauge<float>& gauge, std::vector<GAMMAS>& gammas, bool isZfac);
template void threep_threeD_part4<false,double,double,double,double>(PLEGMA_Correlator<double> &corr, PLEGMA_Vector<double>& prop1, PLEGMA_Vector<double>& prop2, int signProps, PLEGMA_Gauge<double>& gauge, std::vector<GAMMAS>& gammas, bool isZfac);
