...
__global__ void threep_twoD_device(Float2<FloatC>* block2,
				   vectorTex<FloatA> vect1Tex, vectorTex<FloatB> vect2Tex,
  ...
  if (sid3D < DGC_localVolume3D){
    Float2<FloatA> vect1[N_SPINS][N_COLS];
    Float2<FloatB> vect2[N_SPINS][N_COLS];
    ...
    vect1Tex.get(vect1,vid); gaugeTex.get(su3_1,dir1,vid); gaugeTex.get<Plus>(su3_2,dir2,vid,dir1); vect2Tex.get<PlusPlus>(vect2,vid,dir1,dir2);
    partial_trace_mul_Vec_G1_G2_Vec<true,ZERO_PLUS,false,false>(R,vect1,vect2,su3_1,su3_2);

    // - term x, x, x+dir1-dir2^, x+dir1-dir2
    /*vect1Tex.get(vect1,vid);*/ /*gaugeTex.get(su3_1,dir1,vid);*/ gaugeTex.get<PlusMinus>(su3_2,dir2,vid,dir1,dir2); vect2Tex.get<PlusMinus>(vect2,vid,dir1,dir2);
    partial_trace_mul_Prop_G1_G2_Prop<true,ACC_MINUS,false,true>(R,vect1,vect2,su3_1,su3_2);

    // - term x+dir2, x+dir2, x+dir1^, x+dir1
    vect1Tex.get<Plus>(vect1,vid,dir2); gaugeTex.get<Plus>(su3_1,dir1,vid,dir2); gaugeTex.get<Plus>(su3_2,dir2,vid,dir1); vect2Tex.get<Plus>(vect2,vid,dir1);
    partial_trace_mul_Prop_G1_G2_Prop<true,ACC_MINUS,false,true>(R,vect1,vect2,su3_1,su3_2);

    // + term x-dir2, x-dir2, x+dir1-dir2, x+dir1
    vect1Tex.get<Minus>(vect1,vid,dir2); gaugeTex.get<Minus>(su3_1,dir1,vid,dir2); gaugeTex.get<PlusMinus>(su3_2,dir2,vid,dir1,dir2); /*vect2Tex.get<Plus>(vect2,vid,dir1);*/
    partial_trace_mul_Prop_G1_G2_Prop<true,ACC_PLUS,false,false>(R,vect1,vect2,su3_1,su3_2);

    // - term x, x-dir1^, x-dir1, x-dir1+dir2
    vect1Tex.get(vect1,vid); gaugeTex.get<Minus>(su3_1,dir1,vid,dir1); gaugeTex.get<Minus>(su3_2,dir2,vid,dir1); vect2Tex.get<MinusPlus>(vect2,vid,dir1,dir2);
    partial_trace_mul_Prop_G1_G2_Prop<true,ACC_MINUS,true,false>(R,vect1,vect2,su3_1,su3_2);

    // + term x, x-dir1^, x-dir1-dir2^, x-dir1-dir2
    /*vect1Tex.get(vect1,vid);*/ /*gaugeTex.get<Minus>(su3_1,dir1,vid,dir1);*/ gaugeTex.get<MinusMinus>(su3_2,dir2,vid,dir1,dir2); vect2Tex.get<MinusMinus>(vect2,vid,dir1,dir2);
    partial_trace_mul_Prop_G1_G2_Prop<true,ACC_PLUS,true,true>(R,vect1,vect2,su3_1,su3_2);

    // + term x+dir2, x-dir1+dir2^, x-dir1^, x-dir1
    vect1Tex.get<Plus>(vect1,vid,dir2); gaugeTex.get<MinusPlus>(su3_1,dir1,vid,dir1,dir2); gaugeTex.get<Minus>(su3_2,dir2,vid,dir1); vect2Tex.get<Minus>(vect2,vid,dir1);
    partial_trace_mul_Prop_G1_G2_Prop<true,ACC_PLUS,true,true>(R,vect1,vect2,su3_1,su3_2);

    // - term x-dir2, x-dir1-dir2^, x-dir1-dir2, x-dir1
    vect1Tex.get<Minus>(vect1,vid,dir2); gaugeTex.get<MinusMinus>(su3_1,dir1,vid,dir1,dir2); gaugeTex.get<MinusMinus>(su3_2,dir2,vid,dir1,dir2); /*vect2Tex.get<Minus>(vect2,vid,dir1);*/
    partial_trace_mul_Prop_G1_G2_Prop<true,ACC_MINUS,true,false>(R,vect1,vect2,su3_1,su3_2);

    // - term x+dir1, x^, x, x+dir2
    vect1Tex.get<Plus>(vect1,vid,dir1); gaugeTex.get(su3_1,dir1,vid); gaugeTex.get(su3_2,dir2,vid); vect2Tex.get<Plus>(vect2,vid,dir2);
    partial_trace_mul_Prop_G1_G2_Prop<true,ACC_MINUS,true,false>(R,vect1,vect2,su3_1,su3_2);

    // + term x+dir1, x^, x-dir2^, x-dir2
    /*vect1Tex.get<Plus>(vect1,vid,dir1);*/ /*gaugeTex.get(su3_1,dir1,vid);*/ gaugeTex.get<Minus>(su3_2,dir2,vid,dir2); vect2Tex.get<Minus>(vect2,vid,dir2);
    partial_trace_mul_Prop_G1_G2_Prop<true,ACC_PLUS,true,true>(R,vect1,vect2,su3_1,su3_2);

    // - term x-dir1, x-dir1, x-dir2^, x-dir2
    vect1Tex.get<Minus>(vect1,vid,dir1); gaugeTex.get<Minus>(su3_1,dir1,vid,dir1); /*gaugeTex.get<Minus>(su3_2,dir2,vid,dir2);*/ /*vect2Tex.get<Minus>(vect2,vid,dir2);*/
    partial_trace_mul_Prop_G1_G2_Prop<true,ACC_MINUS,false,true>(R,vect1,vect2,su3_1,su3_2);

    // + term x-dir1, x-dir1, x, x+dir2
    /*vect1Tex.get<Minus>(vect1,vid,dir1);*/ /*gaugeTex.get<Minus>(su3_1,dir1,vid,dir1);*/ gaugeTex.get(su3_2,dir2,vid); vect2Tex.get<Plus>(vect2,vid,dir2);
    partial_trace_mul_Prop_G1_G2_Prop<true,ACC_PLUS,false,false>(R,vect1,vect2,su3_1,su3_2);

    // + term x+dir1+dir2, x+dir2^, x^, x
    vect1Tex.get<PlusPlus>(vect1,vid,dir1,dir2); gaugeTex.get<Plus>(su3_1,dir1,vid,dir2); /*gaugeTex.get(su3_2,dir2,vid);*/ vect2Tex.get(vect2,vid);
    partial_trace_mul_Prop_G1_G2_Prop<true,ACC_PLUS,true,true>(R,vect1,vect2,su3_1,su3_2);

    // - term x-dir1+dir2, x-dir1+dir2, x^, x
    vect1Tex.get<MinusPlus>(vect1,vid,dir1,dir2); gaugeTex.get<MinusPlus>(su3_1,dir1,vid,dir1,dir2); /*gaugeTex.get(su3_2,dir2,vid);*/ /*vect2Tex.get(vect2,vid);*/
    partial_trace_mul_Prop_G1_G2_Prop<true,ACC_MINUS,false,true>(R,vect1,vect2,su3_1,su3_2);

    // - term x+dir1-dir2, x-dir2^, x-dir2, x
    vect1Tex.get<PlusMinus>(vect1,vid,dir1,dir2); gaugeTex.get<Minus>(su3_1,dir1,vid,dir2); gaugeTex.get<Minus>(su3_2,dir2,vid,dir2); /*vect2Tex.get(vect2,vid);*/
    partial_trace_mul_Prop_G1_G2_Prop<true,ACC_MINUS,true,false>(R,vect1,vect2,su3_1,su3_2);

    // + term x-dir1-dir2, x-dir1-dir2, x-dir2, x
    vect1Tex.get<MinusMinus>(vect1,vid,dir1,dir2); gaugeTex.get<MinusMinus>(su3_1,dir1,vid,dir1,dir2); /*gaugeTex.get<Minus>(su3_2,dir2,vid,dir2);*/ /*vect2Tex.get(vect2,vid);*/
    partial_trace_mul_Prop_G1_G2_Prop<true,ACC_PLUS,false,false>(R,vect1,vect2,su3_1,su3_2);
    ...
    for(int iop = 0; iop < listGammas.size; iop++){
      ...
      if(notZfac) accum[iop] = 0.0625*((signProps > 0) ? trace_gamma_S<true>(opId,TMP,R) : trace_gamma_S<true>(opId,TMM,R));
...
static void threep_twoD_host(ProfileStruct &ps, Float2<FloatC> *result, PLEGMA_Correlator<FloatC> &corr,
			     PLEGMA_Propagator<FloatA>& vect1, PLEGMA_Propagator<FloatA>& vect2,
  ...
  auto vectorTex1 = toTexture<vectorTex>(vect1);
  auto vectorTex2 = toTexture<vectorTex>(vect2);
  ...
  for(int it=0; it < t_size; it+=time_step) {
	...
	(d_partial_block, *vectorTex1, *vectorTex2, *gaugetex, listGammas, it, t_step, maxT,
...
template<typename FloatC,typename FloatA,typename FloatB,typename FloatG>
void threep_twoD(PLEGMA_Correlator<FloatC> &corr, PLEGMA_Propagator<FloatA>& vect1, PLEGMA_Propagator<FloatB>& vect2,
  ...
  tune( ps, "threep_twoD", threep_twoD_host<FloatC,FloatA,FloatB,FloatG>,
	ps, result, corr, vect1, vect2, signProps, gauge, gammas,false);
  run( ps, "threep_twoD", threep_twoD_host<FloatC,FloatA,FloatB,FloatG>,
       ps, result, corr, vect1, vect2, signProps, gauge, gammas,isZfac);
...
template void threep_twoD<float,float,float,float>(PLEGMA_Correlator<float> &corr, PLEGMA_Propagator<float>& vect1, PLEGMA_Propagator<float>& vect2, int signProps, PLEGMA_Gauge<float>& gauge, std::vector<GAMMAS>& gammas, bool isZfac);
template void threep_twoD<double,double,double,double>(PLEGMA_Correlator<double> &corr, PLEGMA_Propagator<double>& vect1, PLEGMA_Propagator<double>& vect2, int signProps, PLEGMA_Gauge<double>& gauge, std::vector<GAMMAS>& gammas, bool isZfac);
