...
__global__ void threep_oneD_device(Float2<FloatC>* block2,
...
static void threep_oneD_host(ProfileStruct &ps, Float2<FloatC> *result, PLEGMA_Correlator<FloatC> &corr,
			     ...
			     int signProps, gaugeTex<FloatG> gauge, std::vector<GAMMAS> gammas){
  ...
  for(int it=0; it < t_size; it+=time_step) {
    ...
    threep_oneD_device<FloatC,FloatA, FloatB, FloatG>
      ...
      (d_partial_block, prop1, prop2, gauge, listGammas, it, t_step, maxT,
...
template<typename FloatC,typename FloatA,typename FloatB,typename FloatG>
void threep_oneD(PLEGMA_Correlator<FloatC> &corr, propTex<FloatA> prop1, propTex<FloatB> prop2,
		 int signProps, gaugeTex<FloatG> gauge, std::vector<GAMMAS> gammas){
...
template void threep_oneD<float,float,float,float>(PLEGMA_Correlator<float> &corr, propTex<float> prop1, propTex<float> prop2, int signProps, gaugeTex<float> gauge, std::vector<GAMMAS> gammas);
template void threep_oneD<double,double,double,double>(PLEGMA_Correlator<double> &corr, propTex<double> prop1, propTex<double> prop2, int signProps, gaugeTex<double> gauge, std::vector<GAMMAS> gammas);
