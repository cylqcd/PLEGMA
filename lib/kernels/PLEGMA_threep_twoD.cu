...
__global__ void threep_twoD_device(Float2<FloatC>* block2,
  ...
  if (sid3D < DGC_localVolume3D){
    ...
    texture1.get(prop1,vid); gaugeTex.get(su3_1,dir1,vid); gaugeTex.get<Plus>(su3_2,dir2,vid,dir1); texture2.get<PlusPlus>(prop2,vid,dir1,dir2);
    ...
    /*texture1.get(prop1,vid);*/ /*gaugeTex.get(su3_1,dir1,vid);*/ gaugeTex.get<PlusMinus>(su3_2,dir2,vid,dir1,dir2); texture2.get<PlusMinus>(prop2,vid,dir1,dir2);
    ...
    texture1.get<Plus>(prop1,vid,dir2); gaugeTex.get<Plus>(su3_1,dir1,vid,dir2); gaugeTex.get<Plus>(su3_2,dir2,vid,dir1); texture2.get<Plus>(prop2,vid,dir1);
    partial_trace_mul_Prop_G1_G2_Prop<true,ACC_MINUS,false,true>(R,prop1,prop2,su3_1,su3_2,mu,nu,c1,c2);

    // + term x-dir2, x-dir2, x+dir1-dir2, x+dir1
    texture1.get<Minus>(prop1,vid,dir2); gaugeTex.get<Minus>(su3_1,dir1,vid,dir2); gaugeTex.get<PlusMinus>(su3_2,dir2,vid,dir1,dir2); /*texture2.get<Plus>(prop2,vid,dir1);*/
    ...
    texture1.get(prop1,vid); gaugeTex.get<Minus>(su3_1,dir1,vid,dir1); gaugeTex.get<Minus>(su3_2,dir2,vid,dir1); texture2.get<MinusPlus>(prop2,vid,dir1,dir2);
    ...
    /*texture1.get(prop1,vid);*/ /*gaugeTex.get<Minus>(su3_1,dir1,vid,dir1);*/ gaugeTex.get<MinusMinus>(su3_2,dir2,vid,dir1,dir2); texture2.get<MinusMinus>(prop2,vid,dir1,dir2);
    ...
    texture1.get<Plus>(prop1,vid,dir2); gaugeTex.get<MinusPlus>(su3_1,dir1,vid,dir1,dir2); gaugeTex.get<Minus>(su3_2,dir2,vid,dir1); texture2.get<Minus>(prop2,vid,dir1);
    partial_trace_mul_Prop_G1_G2_Prop<true,ACC_PLUS,true,true>(R,prop1,prop2,su3_1,su3_2,mu,nu,c1,c2);

    // - term x-dir2, x-dir1-dir2^, x-dir1-dir2, x-dir1
    texture1.get<Minus>(prop1,vid,dir2); gaugeTex.get<MinusMinus>(su3_1,dir1,vid,dir1,dir2); gaugeTex.get<MinusMinus>(su3_2,dir2,vid,dir1,dir2); /*texture2.get<Minus>(prop2,vid,dir1);*/
    partial_trace_mul_Prop_G1_G2_Prop<true,ACC_MINUS,true,false>(R,prop1,prop2,su3_1,su3_2,mu,nu,c1,c2);

    // - term x+dir1, x^, x, x+dir2
    texture1.get<Plus>(prop1,vid,dir1); gaugeTex.get(su3_1,dir1,vid); gaugeTex.get(su3_2,dir2,vid); texture2.get<Plus>(prop2,vid,dir2);
    partial_trace_mul_Prop_G1_G2_Prop<true,ACC_MINUS,true,false>(R,prop1,prop2,su3_1,su3_2,mu,nu,c1,c2);

    // + term x+dir1, x^, x-dir2^, x-dir2
    /*texture1.get<Plus>(prop1,vid,dir1);*/ /*gaugeTex.get(su3_1,dir1,vid);*/ gaugeTex.get<Minus>(su3_2,dir2,vid,dir2); texture2.get<Minus>(prop2,vid,dir2);
    partial_trace_mul_Prop_G1_G2_Prop<true,ACC_PLUS,true,true>(R,prop1,prop2,su3_1,su3_2,mu,nu,c1,c2);

    // - term x-dir1, x-dir1, x-dir2^, x-dir2
    texture1.get<Minus>(prop1,vid,dir1); gaugeTex.get<Minus>(su3_1,dir1,vid,dir1); /*gaugeTex.get<Minus>(su3_2,dir2,vid,dir2);*/ /*texture2.get<Minus>(prop2,vid,dir2);*/
    partial_trace_mul_Prop_G1_G2_Prop<true,ACC_MINUS,false,true>(R,prop1,prop2,su3_1,su3_2,mu,nu,c1,c2);

    // + term x-dir1, x-dir1, x, x+dir2
    /*texture1.get<Minus>(prop1,vid,dir1);*/ /*gaugeTex.get<Minus>(su3_1,dir1,vid,dir1);*/ gaugeTex.get(su3_2,dir2,vid); texture2.get<Plus>(prop2,vid,dir2);
    partial_trace_mul_Prop_G1_G2_Prop<true,ACC_PLUS,false,false>(R,prop1,prop2,su3_1,su3_2,mu,nu,c1,c2);

    // + term x+dir1+dir2, x+dir2^, x^, x
    texture1.get<PlusPlus>(prop1,vid,dir1,dir2); gaugeTex.get<Plus>(su3_1,dir1,vid,dir2); /*gaugeTex.get(su3_2,dir2,vid);*/ texture2.get(prop2,vid);
    partial_trace_mul_Prop_G1_G2_Prop<true,ACC_PLUS,true,true>(R,prop1,prop2,su3_1,su3_2,mu,nu,c1,c2);

    // - term x-dir1+dir2, x-dir1+dir2, x^, x
    texture1.get<MinusPlus>(prop1,vid,dir1,dir2); gaugeTex.get<MinusPlus>(su3_1,dir1,vid,dir1,dir2); /*gaugeTex.get(su3_2,dir2,vid);*/ /*texture2.get(prop2,vid);*/
    partial_trace_mul_Prop_G1_G2_Prop<true,ACC_MINUS,false,true>(R,prop1,prop2,su3_1,su3_2,mu,nu,c1,c2);

    // - term x+dir1-dir2, x-dir2^, x-dir2, x
    texture1.get<PlusMinus>(prop1,vid,dir1,dir2); gaugeTex.get<Minus>(su3_1,dir1,vid,dir2); gaugeTex.get<Minus>(su3_2,dir2,vid,dir2); /*texture2.get(prop2,vid);*/
    partial_trace_mul_Prop_G1_G2_Prop<true,ACC_MINUS,true,false>(R,prop1,prop2,su3_1,su3_2,mu,nu,c1,c2);

    // + term x-dir1-dir2, x-dir1-dir2, x-dir2, x
    texture1.get<MinusMinus>(prop1,vid,dir1,dir2); gaugeTex.get<MinusMinus>(su3_1,dir1,vid,dir1,dir2); /*gaugeTex.get<Minus>(su3_2,dir2,vid,dir2);*/ /*texture2.get(prop2,vid);*/
    partial_trace_mul_Prop_G1_G2_Prop<true,ACC_PLUS,false,false>(R,prop1,prop2,su3_1,su3_2,mu,nu,c1,c2);
