...
__global__ void threep_twoD_device(Float2<FloatC>* block2,
				   ...
				   int dir1, int dir2, int mu, int nu, int c1, int c2){
  ...
  if (sid3D < DGC->localVolume3D){
    ...
    texture1.get(prop1,vid); gaugeTex.get(su3_1,dir1,vid); gaugeTex.template get<Plus>(su3_2,dir2,vid,dir1); texture2.template get<PlusPlus>(prop2,vid,dir1,dir2);
    ...
    /*texture1.get(prop1,vid);*/ /*gaugeTex.get(su3_1,dir1,vid);*/ gaugeTex.template get<PlusMinus>(su3_2,dir2,vid,dir1,dir2); texture2.template get<PlusMinus>(prop2,vid,dir1,dir2);
    ...
    texture1.template get<Plus>(prop1,vid,dir2); gaugeTex.template get<Plus>(su3_1,dir1,vid,dir2); gaugeTex.template get<Plus>(su3_2,dir2,vid,dir1); texture2.template get<Plus>(prop2,vid,dir1);
    partial_trace_mul_Prop_G1_G2_Prop<true,ACC_MINUS,false,true>(R,prop1,prop2,su3_1,su3_2,mu,nu,c1,c2);

    // + term x-dir2, x-dir2, x+dir1-dir2, x+dir1
    texture1.template get<Minus>(prop1,vid,dir2); gaugeTex.template get<Minus>(su3_1,dir1,vid,dir2); gaugeTex.template get<PlusMinus>(su3_2,dir2,vid,dir1,dir2); /*texture2.get<Plus>(prop2,vid,dir1);*/
    ...
    texture1.get(prop1,vid); gaugeTex.template get<Minus>(su3_1,dir1,vid,dir1); gaugeTex.template get<Minus>(su3_2,dir2,vid,dir1); texture2.template get<MinusPlus>(prop2,vid,dir1,dir2);
    ...
    /*texture1.get(prop1,vid);*/ /*gaugeTex.get<Minus>(su3_1,dir1,vid,dir1);*/ gaugeTex.template get<MinusMinus>(su3_2,dir2,vid,dir1,dir2); texture2.template get<MinusMinus>(prop2,vid,dir1,dir2);
    ...
    texture1.template get<Plus>(prop1,vid,dir2); gaugeTex.template get<MinusPlus>(su3_1,dir1,vid,dir1,dir2); gaugeTex.template get<Minus>(su3_2,dir2,vid,dir1); texture2.template get<Minus>(prop2,vid,dir1);
    partial_trace_mul_Prop_G1_G2_Prop<true,ACC_PLUS,true,true>(R,prop1,prop2,su3_1,su3_2,mu,nu,c1,c2);

    // - term x-dir2, x-dir1-dir2^, x-dir1-dir2, x-dir1
    texture1.template get<Minus>(prop1,vid,dir2); gaugeTex.template get<MinusMinus>(su3_1,dir1,vid,dir1,dir2); gaugeTex.template get<MinusMinus>(su3_2,dir2,vid,dir1,dir2); /*texture2.get<Minus>(prop2,vid,dir1);*/
    partial_trace_mul_Prop_G1_G2_Prop<true,ACC_MINUS,true,false>(R,prop1,prop2,su3_1,su3_2,mu,nu,c1,c2);

    // - term x+dir1, x^, x, x+dir2
    texture1.template get<Plus>(prop1,vid,dir1); gaugeTex.get(su3_1,dir1,vid); gaugeTex.get(su3_2,dir2,vid); texture2.template get<Plus>(prop2,vid,dir2);
    partial_trace_mul_Prop_G1_G2_Prop<true,ACC_MINUS,true,false>(R,prop1,prop2,su3_1,su3_2,mu,nu,c1,c2);

    // + term x+dir1, x^, x-dir2^, x-dir2
    /*texture1.get<Plus>(prop1,vid,dir1);*/ /*gaugeTex.get(su3_1,dir1,vid);*/ gaugeTex.template get<Minus>(su3_2,dir2,vid,dir2); texture2.template get<Minus>(prop2,vid,dir2);
    partial_trace_mul_Prop_G1_G2_Prop<true,ACC_PLUS,true,true>(R,prop1,prop2,su3_1,su3_2,mu,nu,c1,c2);

    // - term x-dir1, x-dir1, x-dir2^, x-dir2
    texture1.template get<Minus>(prop1,vid,dir1); gaugeTex.template get<Minus>(su3_1,dir1,vid,dir1); /*gaugeTex.get<Minus>(su3_2,dir2,vid,dir2);*/ /*texture2.get<Minus>(prop2,vid,dir2);*/
    partial_trace_mul_Prop_G1_G2_Prop<true,ACC_MINUS,false,true>(R,prop1,prop2,su3_1,su3_2,mu,nu,c1,c2);

    // + term x-dir1, x-dir1, x, x+dir2
    /*texture1.get<Minus>(prop1,vid,dir1);*/ /*gaugeTex.get<Minus>(su3_1,dir1,vid,dir1);*/ gaugeTex.get(su3_2,dir2,vid); texture2.template get<Plus>(prop2,vid,dir2);
    partial_trace_mul_Prop_G1_G2_Prop<true,ACC_PLUS,false,false>(R,prop1,prop2,su3_1,su3_2,mu,nu,c1,c2);

    // + term x+dir1+dir2, x+dir2^, x^, x
    texture1.template get<PlusPlus>(prop1,vid,dir1,dir2); gaugeTex.template get<Plus>(su3_1,dir1,vid,dir2); /*gaugeTex.get(su3_2,dir2,vid);*/ texture2.get(prop2,vid);
    partial_trace_mul_Prop_G1_G2_Prop<true,ACC_PLUS,true,true>(R,prop1,prop2,su3_1,su3_2,mu,nu,c1,c2);

    // - term x-dir1+dir2, x-dir1+dir2, x^, x
    texture1.template get<MinusPlus>(prop1,vid,dir1,dir2); gaugeTex.template get<MinusPlus>(su3_1,dir1,vid,dir1,dir2); /*gaugeTex.get(su3_2,dir2,vid);*/ /*texture2.get(prop2,vid);*/
    partial_trace_mul_Prop_G1_G2_Prop<true,ACC_MINUS,false,true>(R,prop1,prop2,su3_1,su3_2,mu,nu,c1,c2);

    // - term x+dir1-dir2, x-dir2^, x-dir2, x
    texture1.template get<PlusMinus>(prop1,vid,dir1,dir2); gaugeTex.template get<Minus>(su3_1,dir1,vid,dir2); gaugeTex.template get<Minus>(su3_2,dir2,vid,dir2); /*texture2.get(prop2,vid);*/
    partial_trace_mul_Prop_G1_G2_Prop<true,ACC_MINUS,true,false>(R,prop1,prop2,su3_1,su3_2,mu,nu,c1,c2);

    // + term x-dir1-dir2, x-dir1-dir2, x-dir2, x
    texture1.template get<MinusMinus>(prop1,vid,dir1,dir2); gaugeTex.template get<MinusMinus>(su3_1,dir1,vid,dir1,dir2); /*gaugeTex.get<Minus>(su3_2,dir2,vid,dir2);*/ /*texture2.get(prop2,vid);*/
    partial_trace_mul_Prop_G1_G2_Prop<true,ACC_PLUS,false,false>(R,prop1,prop2,su3_1,su3_2,mu,nu,c1,c2);
    ...
    for(int iop = 0; iop < listGammas.size; iop++){
      ...
      if(notZfac){
        if (signProps >0){
          accum[iop]=0.0625*trace_gamma_S<true>(opId,TMP,R);
        }
        else if (signProps<0){
          accum[iop]=0.0625*trace_gamma_S<true>(opId,TMM,R);
        }
        else{
          accum[iop]=0.0625*trace_gamma_S<true>(opId,NOROT,R);
        }
      }
...
//  if(error != cudaSuccess || h_partial_block==NULL) goto exit;
  for(int it=0; it < t_size; it+=time_step) {
	...
	c2=tt%N_COLS;
      ...
      threep_twoD_device<b, FloatC,FloatA, FloatB, FloatG>
	<<<grid,ps.tp.block,ps.tp.shared_bytes>>>
	(d_partial_block, *propTex1, *propTex2, *gaugetex, listGammas, it, t_step, maxT,
	 source, signProps, runFT, *moms, dir1,dir2,mu,nu,c1,c2);
...
template<bool b, typename FloatC,typename FloatA,typename FloatB,typename FloatG>
void threep_twoD(PLEGMA_Correlator<FloatC> &corr, 
  ...
  tune( ps, "threep_twoD", threep_twoD_host<b,FloatC,FloatA,FloatB,FloatG>,
	ps, result, corr, prop1, prop2, signProps, gauge, gammas,false);
  run( ps, "threep_twoD", threep_twoD_host<b,FloatC,FloatA,FloatB,FloatG>,
...
template void threep_twoD<true,float,float,float,float>(PLEGMA_Correlator<float> &corr, PLEGMA_Propagator<float>& prop1, PLEGMA_Propagator<float>& prop2, int signProps, PLEGMA_Gauge<float>& gauge, std::vector<GAMMAS>& gammas, bool isZfac);
template void threep_twoD<true,double,double,double,double>(PLEGMA_Correlator<double> &corr, PLEGMA_Propagator<double>& prop1, PLEGMA_Propagator<double>& prop2, int signProps, PLEGMA_Gauge<double>& gauge, std::vector<GAMMAS>& gammas, bool isZfac);
template void threep_twoD<false,float,float,float,float>(PLEGMA_Correlator<float> &corr, PLEGMA_Vector<float>& prop1, PLEGMA_Vector<float>& prop2, int signProps, PLEGMA_Gauge<float>& gauge, std::vector<GAMMAS>& gammas, bool isZfac);
template void threep_twoD<false,double,double,double,double>(PLEGMA_Correlator<double> &corr, PLEGMA_Vector<double>& prop1, PLEGMA_Vector<double>& prop2, int signProps, PLEGMA_Gauge<double>& gauge, std::vector<GAMMAS>& gammas, bool isZfac);
