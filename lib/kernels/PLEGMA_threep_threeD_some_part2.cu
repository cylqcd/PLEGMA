...
__global__ void threep_threeD_part2_device(Float2<FloatC>* block2,
  ...
  if (sid3D < DGC_localVolume3D){
    ...
    prop1Tex.get(prop1,vid); gaugeTex.get<Minus>(su3_1,dir1,vid,dir1); gaugeTex.get<Minus>(su3_2,dir2,vid,dir1); gaugeTex.get<MinusPlus>(su3_3,dir3,vid,dir1,dir2); prop2Tex.get<MinusPlusPlus>(prop2,vid,dir1,dir2,dir3);
    ...
    /*prop1Tex.get(prop1,vid);*/ /*gaugeTex.get<Minus>(su3_1,dir1,vid,dir1);*/ /*gaugeTex.get<Minus>(su3_2,dir2,vid,dir1);*/ gaugeTex.get<MinusPlusMinus>(su3_3,dir3,vid,dir1,dir2,dir3); prop2Tex.get<MinusPlusMinus>(prop2,vid,dir1,dir2,dir3);
    ...
    prop1Tex.get<Plus>(prop1,vid,dir3); gaugeTex.get<MinusPlus>(su3_1,dir1,vid,dir1,dir3); gaugeTex.get<MinusPlus>(su3_2,dir2,vid,dir1,dir3); gaugeTex.get<MinusPlus>(su3_3,dir3,vid,dir1,dir2); prop2Tex.get<MinusPlus>(prop2,vid,dir1,dir2);
    partial_trace_mul_Prop_G1_G2_G3_Prop<true,ACC_PLUS,true,false,true>(R,prop1,prop2,su3_1,su3_2,su3_3,mu,nu,c1,c2);

    // - term x-dir3, x-dir1-dir3^, x-dir1-dir3, x-dir1+dir2-dir3, x-dir1+dir2
    prop1Tex.get<Minus>(prop1,vid,dir3); gaugeTex.get<MinusMinus>(su3_1,dir1,vid,dir1,dir3); gaugeTex.get<MinusMinus>(su3_2,dir2,vid,dir1,dir3); gaugeTex.get<MinusPlusMinus>(su3_3,dir3,vid,dir1,dir2,dir3); /*prop2Tex.get<MinusPlus>(prop2,vid,dir1,dir2);*/
    ...
    prop1Tex.get(prop1,vid); gaugeTex.get<Minus>(su3_1,dir1,vid,dir1); gaugeTex.get<MinusMinus>(su3_2,dir2,vid,dir1,dir2); gaugeTex.get<MinusMinus>(su3_3,dir3,vid,dir1,dir2); prop2Tex.get<MinusMinusPlus>(prop2,vid,dir1,dir2,dir3);
    ...
    /*prop1Tex.get(prop1,vid);*/ /*gaugeTex.get<Minus>(su3_1,dir1,vid,dir1);*/ /*gaugeTex.get<MinusMinus>(su3_2,dir2,vid,dir1,dir2);*/ gaugeTex.get<MinusMinusMinus>(su3_3,dir3,vid,dir1,dir2,dir3); prop2Tex.get<MinusMinusMinus>(prop2,vid,dir1,dir2,dir3);
    ...
    prop1Tex.get<Plus>(prop1,vid,dir3); gaugeTex.get<MinusPlus>(su3_1,dir1,vid,dir1,dir3); gaugeTex.get<MinusMinusPlus>(su3_2,dir2,vid,dir1,dir2,dir3); gaugeTex.get<MinusMinus>(su3_3,dir3,vid,dir1,dir2); prop2Tex.get<MinusMinus>(prop2,vid,dir1,dir2);
    partial_trace_mul_Prop_G1_G2_G3_Prop<true,ACC_MINUS,true,true,true>(R,prop1,prop2,su3_1,su3_2,su3_3,mu,nu,c1,c2);

    // + term x-dir3, x-dir1-dir3^, x-dir1-dir2-dir3^, x-dir1-dir2-dir3, x-dir1-dir2
    prop1Tex.get<Minus>(prop1,vid,dir3); gaugeTex.get<MinusMinus>(su3_1,dir1,vid,dir1,dir3); gaugeTex.get<MinusMinusMinus>(su3_2,dir2,vid,dir1,dir2,dir3); gaugeTex.get<MinusMinusMinus>(su3_3,dir3,vid,dir1,dir2,dir3); /*prop2Tex.get<MinusMinus>(prop2,vid,dir1,dir2);*/
    partial_trace_mul_Prop_G1_G2_G3_Prop<true,ACC_PLUS,true,true,false>(R,prop1,prop2,su3_1,su3_2,su3_3,mu,nu,c1,c2);

    // + term x+dir2, x-dir1+dir2^, x-dir1^, x-dir1, x-dir1+dir3
    prop1Tex.get<Plus>(prop1,vid,dir2); gaugeTex.get<MinusPlus>(su3_1,dir1,vid,dir1,dir2); gaugeTex.get<Minus>(su3_2,dir2,vid,dir1); gaugeTex.get<Minus>(su3_3,dir3,vid,dir1); prop2Tex.get<MinusPlus>(prop2,vid,dir1,dir3);
    partial_trace_mul_Prop_G1_G2_G3_Prop<true,ACC_PLUS,true,true,false>(R,prop1,prop2,su3_1,su3_2,su3_3,mu,nu,c1,c2);

    // - term x+dir2, x-dir1+dir2^, x-dir1^, x-dir1-dir3^, x-dir1-dir3
    /*prop1Tex.get<Plus>(prop1,vid,dir2);*/ /*gaugeTex.get<MinusPlus>(su3_1,dir1,vid,dir1,dir2);*/ /*gaugeTex.get<Minus>(su3_2,dir2,vid,dir1);*/ gaugeTex.get<MinusMinus>(su3_3,dir3,vid,dir1,dir3); prop2Tex.get<MinusMinus>(prop2,vid,dir1,dir3);
    partial_trace_mul_Prop_G1_G2_G3_Prop<true,ACC_MINUS,true,true,true>(R,prop1,prop2,su3_1,su3_2,su3_3,mu,nu,c1,c2);

    // - term x+dir2+dir3, x-dir1+dir2+dir3^, x-dir1+dir3^, x-dir1^, x-dir1
    prop1Tex.get<PlusPlus>(prop1,vid,dir2,dir3); gaugeTex.get<MinusPlusPlus>(su3_1,dir1,vid,dir1,dir2,dir3); gaugeTex.get<MinusPlus>(su3_2,dir2,vid,dir1,dir3); gaugeTex.get<Minus>(su3_3,dir3,vid,dir1); prop2Tex.get<Minus>(prop2,vid,dir1);
    partial_trace_mul_Prop_G1_G2_G3_Prop<true,ACC_MINUS,true,true,true>(R,prop1,prop2,su3_1,su3_2,su3_3,mu,nu,c1,c2);

    // + term x+dir2-dir3, x-dir1+dir2-dir3^, x-dir1-dir3^, x-dir1-dir3, x-dir1
    prop1Tex.get<PlusMinus>(prop1,vid,dir2,dir3); gaugeTex.get<MinusPlusMinus>(su3_1,dir1,vid,dir1,dir2,dir3); gaugeTex.get<MinusMinus>(su3_2,dir2,vid,dir1,dir3); gaugeTex.get<MinusMinus>(su3_3,dir3,vid,dir1,dir3); /*prop2Tex.get<Minus>(prop2,vid,dir1);*/
    partial_trace_mul_Prop_G1_G2_G3_Prop<true,ACC_PLUS,true,true,false>(R,prop1,prop2,su3_1,su3_2,su3_3,mu,nu,c1,c2);

    // - term x-dir2, x-dir1-dir2^, x-dir1-dir2, x-dir1, x-dir1+dir3
    prop1Tex.get<Minus>(prop1,vid,dir2); gaugeTex.get<MinusMinus>(su3_1,dir1,vid,dir1,dir2); gaugeTex.get<MinusMinus>(su3_2,dir2,vid,dir1,dir2); gaugeTex.get<Minus>(su3_3,dir3,vid,dir1); prop2Tex.get<MinusPlus>(prop2,vid,dir1,dir3);
    partial_trace_mul_Prop_G1_G2_G3_Prop<true,ACC_MINUS,true,false,false>(R,prop1,prop2,su3_1,su3_2,su3_3,mu,nu,c1,c2);

    // + term x-dir2, x-dir1-dir2^, x-dir1-dir2, x-dir1-dir3^, x-dir1-dir3
    /*prop1Tex.get<Minus>(prop1,vid,dir2);*/ /*gaugeTex.get<MinusMinus>(su3_1,dir1,vid,dir1,dir2);*/ /*gaugeTex.get<MinusMinus>(su3_2,dir2,vid,dir1,dir2);*/ gaugeTex.get<MinusMinus>(su3_3,dir3,vid,dir1,dir3); prop2Tex.get<MinusMinus>(prop2,vid,dir1,dir3);
    partial_trace_mul_Prop_G1_G2_G3_Prop<true,ACC_PLUS,true,false,true>(R,prop1,prop2,su3_1,su3_2,su3_3,mu,nu,c1,c2);

    // + term x-dir2+dir3, x-dir1-dir2+dir3^, x-dir1-dir2+dir3, x-dir1^, x-dir1
    prop1Tex.get<MinusPlus>(prop1,vid,dir2,dir3); gaugeTex.get<MinusMinusPlus>(su3_1,dir1,vid,dir1,dir2,dir3); gaugeTex.get<MinusMinusPlus>(su3_2,dir2,vid,dir1,dir2,dir3); gaugeTex.get<Minus>(su3_3,dir3,vid,dir1); prop2Tex.get<Minus>(prop2,vid,dir1);
    partial_trace_mul_Prop_G1_G2_G3_Prop<true,ACC_PLUS,true,false,true>(R,prop1,prop2,su3_1,su3_2,su3_3,mu,nu,c1,c2);

    // - term x-dir2-dir3, x-dir1-dir2-dir3^, x-dir1-dir2-dir3, x-dir1-dir3, x-dir1
    prop1Tex.get<MinusMinus>(prop1,vid,dir2,dir3); gaugeTex.get<MinusMinusMinus>(su3_1,dir1,vid,dir1,dir2,dir3); gaugeTex.get<MinusMinusMinus>(su3_2,dir2,vid,dir1,dir2,dir3); gaugeTex.get<MinusMinus>(su3_3,dir3,vid,dir1,dir3); /*prop2Tex.get<Minus>(prop2,vid,dir1);*/
    partial_trace_mul_Prop_G1_G2_G3_Prop<true,ACC_MINUS,true,false,false>(R,prop1,prop2,su3_1,su3_2,su3_3,mu,nu,c1,c2);
...
static void threep_threeD_part2_host(ProfileStruct &ps, Float2<FloatC> *result, PLEGMA_Correlator<FloatC> &corr,
  ...
  int extra=N_DIMS*(N_DIMS-1)*(N_DIMS-2)/3;
  ...
  for(int it=0; it < t_size; it+=time_step) {
	...
	c2=tt%N_COLS;
      ...
      threep_threeD_part2_device<FloatC,FloatA, FloatB, FloatG>
...
void threep_threeD_part2(PLEGMA_Correlator<FloatC> &corr, PLEGMA_Propagator<FloatA>& prop1, PLEGMA_Propagator<FloatB>& prop2,
  ...
  bool runFT = (corr.getCorrSpace() == MOMENTUM_SPACE);
  int site_size = N_DIMS*(N_DIMS-1)*(N_DIMS-2)*gammas.size()/3;
  ...
  run( ps, "threep_threeD", threep_threeD_part2_host<FloatC,FloatA,FloatB,FloatG>,
...
template void threep_threeD_part2<float,float,float,float>(PLEGMA_Correlator<float> &corr, PLEGMA_Propagator<float>& prop1, PLEGMA_Propagator<float>& prop2, int signProps, PLEGMA_Gauge<float>& gauge, std::vector<GAMMAS>& gammas, bool isZfac);
template void threep_threeD_part2<double,double,double,double>(PLEGMA_Correlator<double> &corr, PLEGMA_Propagator<double>& prop1, PLEGMA_Propagator<double>& prop2, int signProps, PLEGMA_Gauge<double>& gauge, std::vector<GAMMAS>& gammas, bool isZfac);
