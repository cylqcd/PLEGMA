...
// input is M and output is U
template<typename Float>
inline __device__ void su3Projection(Float2<Float> U[N_COLS][N_COLS],Float2<Float> M[N_COLS][N_COLS]){
  Float2<Float>  H[N_COLS][N_COLS] , v[N_COLS][N_COLS] , vr[N_COLS][N_COLS];
  Float e[N_COLS];
  ...
  if(sum <= 1e-8){ // if H^2 is already diagonal
#pragma unroll
