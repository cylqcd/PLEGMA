 ...
 */
Hprobing::Hprobing(int k_probing, int d, bool check):k(k_probing),Nc(0),d(d),D(0),Lu(0),h_arrVc(nullptr),d_arrVc(nullptr),arrlc(nullptr){
...
void Hprobing::createColLattice(){
