...
enum ALLOCATION_FLAG{HOST,DEVICE,BOTH,NONE};

enum CLASS_ENUM{CUSTOM,SCALAR,SU3FIELD,GAUGE,VECTOR,PROPAGATOR,PROPAGATOR3D,VECTOR3D,QLOOPS,FMUNU};
...
enum GAMMAS_SCATT {ID,G_1,G_2,G_3,G_4,G_5,CG_1,CG_2,CG_3,CG_1_G_4,CG_2_G_4,CG_3_G_4,CG1_G_4_G5,CG_2_G_4_G_5,CG_3_G_4_G_5}; // Do not change this order
