...
namespace plegma {
  ...
  public:
    ...
    void copyToQUDA( std::vector<quda::ColorSpinorField>& cudaVector, int src,  bool isEv = false);
    void copyFromQUDA( std::vector<quda::ColorSpinorField>& cudaVector, int src, bool isEv = false);
  ...
  template<typename Float> void copyToQUDA(std::vector<quda::ColorSpinorField>& cudaVector, Float* delem, int src, bool isEv = false); // delem is a device pointer
  template<typename Float> void copyFromQUDA(Float* delem, std::vector<quda::ColorSpinorField>& cudaVector, int src, bool isEv = false);
