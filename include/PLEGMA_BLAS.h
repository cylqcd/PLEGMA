...
template<typename Float>
void cublas_axpy(int NN, Float val[2], Float *x, Float *y){}

template<>
void cublas_axpy<float>(int NN, float val[2], float *x, float *y){
...
template<>
void cublas_axpy<double>(int NN, double val[2], double *x, double *y){
