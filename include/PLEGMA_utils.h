...
template<typename Float> void V_M_V( Float * V1, Float * V2, GAMMAS gamma, Float *Dest);
template<typename Float, int s_free> void V_TR_MM( Float *V1, GAMMAS gamma, Float *Dest);
