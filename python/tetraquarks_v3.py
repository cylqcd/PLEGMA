...
all_gammas[1] = {
    ...
    "g5-gj-g5-gj_ll" : {
        ...
        (g5, gz, g5.conj().T, gz.conj().T)
            ...
            #"quarkPositions" : ["x","x","x","x","z","z","z","z"],
            #"corrType"  : ["ll"],
            #"propType"  : ["point-to-all"],
        },
    "g5-gj-gj-g5_ll" : {
            "gammaMatrix" :[
    ...
    #"g5-gj-g5-gj_sl" : {
        ...
        #(g5, gz, g5.conj().T, gz.conj().T)
    #],            
            #"quarkPositions" : ["x","x","y","y","z","z","z","z"],
            #"corrType"  : ["sl"],
            #"propType"  : ["point-to-all"],
        #},
    #"g5-gj-gj-g5_sl" : {
...
string = (
    "const " + vec("std::string") + " TETRA_prop_prods = {" + ", ".join(props) + "};\n"
)
file1.write(string)
